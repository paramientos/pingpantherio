...
function StatusPagesCreate({ monitors }) {
    const form = useForm({
        initialValues: {
            name: '',
            slug: '',
    ...
    const handleSubmit = (values) => {
        router.post('/status-pages', values, {
            onSuccess: () => {
                notifications.show({
                    title: 'Success',
    ...
    const handleNameChange = (value) => {
        ...
        if (!form.values.slug) {
            form.setFieldValue('slug', value.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/^-|-$/g, ''));
        }
    };
            ...
            <Stack gap="xl">
                ...
                <div>
                    ...
                    <Text c="dimmed" size="sm" mt={4}>
                        Create a beautiful public status page for your services
                    </Text>
                </div>
...
export default StatusPagesCreate;
